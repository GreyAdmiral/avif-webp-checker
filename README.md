...
```html
<script src="https://cdn.jsdelivr.net/npm/avif-webp-checker@1.0.5/dist/avif-webp-checker.min.js"></script>
```

or

```html
<script src="https://unpkg.com/avif-webp-checker@1.0.5/dist/avif-webp-checker.min.js"></script>
```
